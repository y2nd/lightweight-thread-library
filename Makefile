...
# Gestion des options
OPTIONS:=SCHED USE_CTOR Q_LOOP Q_MEM_POOL Q_MEM_POOL_G T_MEM_POOL T_MEM_POOL_G PREEMPT THREAD_LIMIT
SUFFIX:=
...
check: test
	...
	LD_LIBRARY_PATH=install/lib install/bin/71-preemption$(SUFFIX) 100
