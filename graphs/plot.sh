...
test "01-main" "01-main$SUFFIXE1" "01-main$SUFFIXE2" 100 100
test "02-switch" "02-switch$SUFFIXE1" "02-switch$SUFFIXE2" 100 100
test "03-equity" "03-equity$SUFFIXE1" "03-equity$SUFFIXE2" 100 100
test "11-join" "11-join$SUFFIXE1" "11-join$SUFFIXE2" 100 100
test "12-join-main" "12-join-main$SUFFIXE1" "12-join-main$SUFFIXE2" 100 100
test "21-create-many" "21-create-many$SUFFIXE1" "21-create-many$SUFFIXE2" 10 10 10000
test "22-create-many-recursive" "22-create-many-recursive$SUFFIXE1" "22-create-many-recursive$SUFFIXE2" 10 10 10000
test "23-create-many-once" "23-create-many-once$SUFFIXE1" "23-create-many-once$SUFFIXE2" 10 10 10000
